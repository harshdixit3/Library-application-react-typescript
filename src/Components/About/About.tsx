    ...
    <main>
      <section>
        ...
        <p>
          ...
          (which in turn uses <a href="https://getbootstrap.com/">Bootstrap</a>
          ).{" "}
          <a href="https://www.typescriptlang.org/docs/handbook/intro.html">
            Typescript
          </a>{" "}
          is the language of choice. The backend is built using{" "}
          <a href="https://github.com/typicode/json-server">json-server</a>. The
          icons used have been courtesy{" "}
